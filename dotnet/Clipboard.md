#Using Clipboard in Console Application#
```csharp
using System;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if(Clipboard.ContainsImage()) {
                ...
                img.Save("a.png", ImageFormat.Png);
            }
...
#[Setting HTML/Text to Clipboard revisited ](http://theartofdev.com/2014/06/12/setting-htmltext-to-clipboard-revisited/)#
```csharp
/// <summary>      
...
[Clipboard Assistant](http://stackoverflow.com/a/1394225/266726)
```csharp
using System;
